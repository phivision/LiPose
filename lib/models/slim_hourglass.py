...
class SlimHourglass(Model):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        front_features = create_front_module(inputs, self.num_features, bottleneck_mobile)
    ...
    def __init__(self, num_classes, num_stacks, num_features, input_shape):
...
def get_hourglass_model(num_classes, num_stacks, num_features, input_size=None, input_type='rgb'):
    ...
    Args:
        ...
        input_size: the shape of input image, shall match the channel number
